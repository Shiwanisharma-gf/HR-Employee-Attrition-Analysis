...
# Employee Attrition & Workplace Analysis 📊

In this project, I analyzed an HR dataset to understand why employees leave companies (attrition) and what factors impact their decisions the most. 
...
* **File Name:** `employee_attrition_hr_2026.csv`
* **Size:** 5,000 rows × 29 columns
* **Key Columns:**
  * `age`, `gender`, `marital_status`, `education_level`
  * `department`, `job_role`, `job_level`, `monthly_income`
  * `burnout_score`, `work_life_balance_score`, `manager_support_score`
